...
#4
It works, however I only tested with all elements equal to 7 and 8x8 array.
#5
...
A very rough estimant is the the program used to be O(2n^2) with n being 2048 (DIM),
